...
from kbcr.models import DistMult
from kbcr.models import ComplEx
...
def main(argv):
    ...
    parser.add_argument('--init-size', '-i', action='store', type=float, default=1e-3)
    ...
    base_model = model_factory[model_name]().to(device)
