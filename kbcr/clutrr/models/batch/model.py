...
from kbcr.clutrr.models.batch.kb import BatchNeuralKB
from kbcr.clutrr.models.batch.util import uniform
...
class BatchHoppy(nn.Module):
    ...
    def r_hop(self,
        ...
        dim_1 = torch.arange(z_scores.shape[0]).view(-1, 1).repeat(1, k).view(-1)
    ...
    def depth_r_score(self,
        ...
        if depth == 0:
            return self.model.score(rel, arg1, arg2, facts, nb_facts)
        ...
        for rule_idx, (hops_generator, is_reversed) in enumerate(new_hops_lst):
            ...
            if scores is not None:
                ...
                res = self.model.score(rel, arg1, arg2, facts, nb_facts)
